...
sudo qemu-system-x86_64 -hda lite10.qcow2 -m 8G -vnc :0 -smp cores=2  -net user -net nic -object rng-random -machine usb=on -device usb-tablet,id=rng0,filename=/dev/urandom -device virtio-rng-pci,rng=rng0 -vga qxl -accel kvm &>/dev/null &
sleep 43200
